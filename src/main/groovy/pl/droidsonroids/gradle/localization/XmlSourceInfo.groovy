...
class XmlSourceInfo {
    ...
    XmlSourceInfo(String[] headerLine, ConfigExtension config, File resDir) {
        this(headerLine, config, resDir, config.outputFileName)
    }

    XmlSourceInfo(String[] headerLine, ConfigExtension config, File resDir, String outputFileName) {
